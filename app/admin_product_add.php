    ...
    <div class="edit__title title_padding orange fontSans text-center size29px">Добавление товара</div>
        ...
        <form class="d-flex bottom_padding flex-xl-row flex-lg-row flex-md-column flex-sm-column flex-column" enctype="multipart/form-data">
         ...
         <div class="edit-cart__content edit-cart__content_padding d-flex justify-content-between">
            ...
            <div class="edit-cart__item-input col-xl-6 col-lg-8 col-md-12 col-sm-12"><select type="text" value="Пирожные"  name="category" class="edit-cart__item-input">
        ...
        <div class="edit-cart__content edit-cart__content_padding d-flex justify-content-between">
            ...
            <div class="d-flex">
                <input value="new" type="checkbox" name="new" class="">
                <div class="edit-cart__item-input">Новинка!</div>
            </div>
             <div class="d-flex">
                <input value="best" type="checkbox" name="best" class="">
                <div class="edit-cart__item-input"> Бестселлер</div>
            </div>
             <div class="d-flex">
                <input value="profit" type="checkbox" name="profit" class="">
                <div class="edit-cart__item-input">  Выгодно</div>
            </div>
             
            <div class="d-flex">
                <input value="hidden" type="checkbox" name="hidden" class="">
          ...
          <div class="edit-cart__content edit-cart__content_padding d-flex justify-content-between">
            ...
            <div class="col-xl-6 col-lg-8 col-md-12 col-sm-12 flex-column">
             ...
             <div class="d-flex">
                <input  type="radio" value="profit" name="nal" class="">
                <div class="edit-cart__item-input">В наличии</div>
            </div>
             
            <div class="d-flex">
                <input type="radio" value="hidden"  name="nal" class="">
                <div class="edit-cart__item-input">Не в наличии</div>
            </div>
        </div>
        ...
        col-sm-4 col-6" type="submit" name="submit">Сохранить</button></div>
        </div>
