<div class="wrap-content">
   ...
   <div class="navy prev-slide d-flex col-xl-1 justify-content-center"><div class="navy-phone"><img src="../images/arrow1.png"></div></div>
   <div class="navy next-slide col-xl-1 d-flex justify-content-center"><div class="navy-phone"><img src="../images/arrow.png"></div></div></div>
      ...
      <div class="slide-list col-xl-12 col-md-12 col-sm-12">
         <div class="slide-wrap">
             <div class="slide-item d-flex flex-column align-items-center">
               <div class="slide-img"><img  src="images/page.png" alt="" /></div>
            ...
            <div class="slide-item d-flex flex-column align-items-center">
               <div class="slide-img"><img  src="images/page1.png" alt="" /></div>
              <div class="slide-item__value size45px burgundyLight">300 P</div>
            ...
            <div class="slide-item d-flex flex-column align-items-center">
               <div class="slide-img"><img  src="images/page2.png" alt="" /></div>
               <div class="slide-item__value size45px burgundyLight">300 P</div>
               <div class="slide-item__slogan orange size24px fontTahoma letter-space">Бестселлер</div>
            ...
            <div class="slide-item d-flex flex-column align-items-center">
               <div class="slide-img"><img  src="images/page3.png" alt="" /></div>
               <div class="slide-item__value size45px burgundyLight">300 P</div>
            ...
            <div class="slide-item d-flex flex-column align-items-center">
               <div class="slide-img"><img  src="images/page4.png" alt="" /></div>
               <div class="slide-item__value size45px burgundyLight">300 P</div>
               <div class="slide-item__slogan orange size24px fontTahoma letter-space">Бестселлер</div>
             ...
             <div class="slide-item d-flex flex-column align-items-center">
               <div class="slide-img"><img  src="images/page5.png" alt="" /></div>
              <div class="slide-item__value size45px burgundyLight">300 P</div>
               <div class="slide-item__slogan orange size24px fontTahoma letter-space">Бестселлер</div>
             ...
             <div class="slide-item d-flex flex-column align-items-center">
               <div class="slide-img"><img  src="images/page6.png" alt="" /></div>
              <div class="slide-item__value size45px burgundyLight">300 P</div>
               <div class="slide-item__slogan orange size24px fontTahoma letter-space myGreen">Новинка!</div>
             ...
             <div class="slide-item d-flex flex-column align-items-center">
               <div class="slide-img"><img  src="images/page7.png" alt="" /></div>
              <div class="slide-item__value size45px burgundyLight">300 P</div>
               <div class="slide-item__slogan orange size24px fontTahoma letter-space myBlue">Выгодно</div>
