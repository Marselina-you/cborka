<div class="wrap-main-order wrap-main_padding">
   <div class="main-order">
       <div class="wrap-main-order-content col-xl-6 offset-xl-1">
   ...
   <form class="main-order-content__form form_padding d-flex flex-column"  method="post">
      ...
      <div class="content-form__data d-flex align-items-center justify-content-between">
         <div class="content-form__data-title size35px col-xl-4">Фамилия:</div>
          <div class="wrap-content-form__data-input col-xl-8">
            <input type="text" name="" class="content-form__data-input col-xl-12"></div>
      </div>
