<div class="wrap-main-enter wrap-main_padding">
   ...
   <form class="main-enter-content__form form_padding  d-flex flex-column"  method="post">
      ...
      <div class="content-form__data d-flex align-items-center justify-content-between flex-xl-row flex-lg-row flex-md-row flex-sm-column flex-column">
          ...
          <div class="wrap-content-form__data-input col-xl-8">
            <input type="text" name="parol" class="content-form__data-input col-xl-12"></div>
      </div>
...
<button class="content-order-end__click__btn btn btn-success size29px col-xl-6" type="button">Войти</button></div></div>
   </form>
